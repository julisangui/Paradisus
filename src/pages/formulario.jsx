            ...
            <div className="fila">
              ...
              <div>
                ...
                <input
                  type="number"
                  name="numeroTarjeta"
                  value={dato.numeroTarjeta}
                  onChange={handleChange}
                  placeholder="Ingrese un número cualquiera"
                  required
                />
              </div>
            </div>
