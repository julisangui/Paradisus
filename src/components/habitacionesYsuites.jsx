...
const habitacionesYsuites = () =>{
    return (
        <>
            <div className='seccion1' id='habitacionesYsuites'>
                ...
                <div className='tarjeta tarjeta1'>
                    ...
                    <div className='descripcion'>
                        ...
                        <button>Reservar<i className="bi bi-chevron-right"></i></button>
                    </div>
                </div>
                ...
                <div className='tarjeta tarjeta2'>
                    ...
                    <div className='descripcion'>
                        ...
                        <button>Mirar y seleccionar<i className="bi bi-chevron-right"></i></button>
                    </div>
                </div>
            </div>
        </>
...
export default habitacionesYsuites