...
const ActividadesYServicios = () => {
  ...
  const slides = [
...

    {
      ...
      titulo: "Gastronomía",
      descripcion:
        "Descubre el sabor de cada platillo de diferentes culturas y disfruta de una experiencia única con una auténtica parrilla argentina en la playa.",
    },

    {
      ...
      descripcion:
        "Disfruta de una amplia variedad de experiencias en el mar, desde el snorkel y buceo en arrecifes de coral hasta el emocionante nado con delfines y tiburones nodriza. Para los amantes de la adrenalina, el parasailing te llevará a nuevas alturas con vistas espectaculares del océano.",
    },

    {
      ...
      descripcion:
        "Explora la naturaleza con recorridos en 4x4 o buggies por parques nacionales y cuevas, observa la vida silvestre en reservas naturales o sumérgete en la historia con visitas a ruinas y sitios culturales.",
    },
  ];
        ...
        {slides.map((slide, index) => (
          <div
            ...
            className={`tarjeta-expandible ${
              tarjetaAbierta === index ? "active" : ""
            }`}
            onClick={() => clickVerTarjeta(index)}
          >
